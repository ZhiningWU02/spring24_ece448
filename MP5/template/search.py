...
def best_first_search(starting_state):
    ...
    while frontier:
        ...
        for neighbor in current_state.get_neighbors():
            new_distance = neighbor.dist_from_start
            if (
                neighbor not in visited_states
                or new_distance < visited_states[neighbor][1]
            ):
                visited_states[neighbor] = (current_state, new_distance)
